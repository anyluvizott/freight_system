...
describe 'Usuário vê os veículos cadastrados' do
  ...
  it 'com sucesso' do
    ...
    utili = Carrier.create!(drivers_name: 'Gabriela Almeida', nameplate: 'KLO6S98',
                            vehicle_model: 'Renault Master 2.3 DCI Furgão L1H1 - Diesel', vehicle_brand: 'Renault', year_of_manufacture: 2019, maximum_weight: 1_500, transport_model: transp)

    moto = Carrier.create!(drivers_name: 'Roberto Siqueira', nameplate: 'FDS5A44',
                           vehicle_model: 'Triciclo Sousa Mod. TR 150', vehicle_brand: 'Sousa Motos', year_of_manufacture: 2018, maximum_weight: 300, transport_model: transp1)
    ...
    expect(page).to have_content 'Gabriela Almeida - Renault Master 2.3 DCI Furgão L1H1 - Diesel'
    expect(page).to have_content 'Roberto Siqueira - Triciclo Sousa Mod. TR 150'
  end
